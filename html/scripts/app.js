	...
	let menus = {
		...
		cloakroom : {
		  ...
		  items: [
		  	...
		  	{label: 'Tenue Entreprise', value: 'job_wear'},
		  ]
		},
		...
		vehiclespawner : {
		  ...
		  items: [
		    {label: 'Camionnette', value: 'burrito'},
		  	{label: 'SUV', value: 'rocoto'},
		  ]
		},
		actions : {
		  title     : 'Metier',
		  ...
		  items : [
		  	{label: 'Placer un plot',  value: 'add_plot'},
		  	{label: 'Supprimer un plot', value: 'delete_plot'},
		  	{label: 'Placer une barriere',  value: 'add_barrier'},
		  	{label: 'Supprimer une barriere', value: 'delete_barrier'},
		  	{label: 'Placer un tremplin',  value: 'add_tremplin'},
		  	{label: 'Supprimer un tremplin', value: 'remove_tremplin'},
		  ]
		},
	}
